...
switch ($version) {
    case "e1":
        $subject = "FIRSTNAME, Important Note About Your Beneficiary Information ";
		$preheader = "...";
        break;
...
<body>
	<div id="container">
		<div id="navigation">
			<p><strong>ALL-9245 ADA Beneficiary Email</strong></p>
			<p><strong>Versions</strong></p>
			<ul>
			<?php
echo "<li><a href=index.php?s=s1&v=e1&w=" . $width . "&h=" . $height . ">E1</a><br><br></li>";
?>
			</ul>
		</div>
		<div id="email">
