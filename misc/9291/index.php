...
switch ($version) {
    case "e1":
        $subject = "Dr. [Lastname]: Meet protection worth smiling about at SmileCon";
		$preheader = "...";
        break;
    case "e2":
        $subject = "Your SmileCon takeaway: Protection worth smiling about";
		$preheader = "...";
        break;
    case "e3":
        ...
        break;
    case "e4":
        $subject = "Your no-cost (to you) ADA student insurance &ndash;on’t miss out";
		$preheader = "...";
        break;
    default:
        $subject = "";
...
<body>
	<div id="container">
		<div id="navigation">
			<p><strong>ALL-9291 SmileCon Emails</strong></p>
...
echo "<li><a href=index.php?s=s1&v=e3&w=" . $width . "&h=" . $height . ">Pre-Conference Email (Students)</a></li>";
echo "<li><a href=index.php?s=s1&v=e4&w=" . $width . "&h=" . $height . ">Post-Conference Email (Students)</a></li>";
?>
			</ul>
		</div>
		<div id="email">
