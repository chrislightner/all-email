...
switch ($version) {
    case "e1":
        $subject = "[Reminder] [NAME], act now to continue your ADA insurance coverage";
		$preheader = "This important protection may never be easier to get – reply by 3/31";
        break;
...
<body>
	<div id="container">
		<div id="navigation">
			<p><strong>ALL-9453  Emails</strong></p>
