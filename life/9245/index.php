...
<body>
	<div id="container">
		<div id="navigation">
			<p><strong>ALL-9245 ADA Life Email</strong></p>
  ...
  <p><?php echo "Preheader: " . $preheader ?></p>
			...
			<div id="content">
				<div id="device">
					<?php
echo "<a href=index.php?s=" . $subjectv . "&v=" . $version . "&cu=" . $cu . "&w=740&h=800>Desktop</a> | <a href=index.php?s=" . $subjectv . "&v=" . $version . "&cu=" . $cu . "&w=320&h=480>iPhone</a> | <a href=ada_life_" . $version . ".html>Content Only</a>";
?>
				</div>
				<div>
					<?php
echo "<iframe width=" . $width . " height=" . $height . " src=ada_life_" . $version . ".html></iframe>";
?>
				</div>
			</div>
		</div>
