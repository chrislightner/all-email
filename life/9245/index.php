 ...
 * 1. CONFIGURATION
 */
$projectName = "ALL-9245 ADA Life Email";
...
[
    'ada-e1' => [
        'subject1'   => "(NEW) Dr. [NAME], now choose your own cost with ADA Life Insurance",
        'subject2'   => "TBD",
        'preheader1' => "Save with affordable ADA member group rates",
        'preheader2' => "TBD",
    ],
    'ada-e2' => [
        'subject1'   => "ADA Life Insurance now lets you choose your own cost",
        'subject2'   => "TBD",
        'preheader1' => "Save with affordable ADA member group rates",
        'preheader2' => "TBD",
    ],
    'ada-e3' => [
        'subject1'   => "(NEW) Dr. [NAME], add to your ADA Life Insurance at a cost you choose",
        'subject2'   => "TBD",
        'preheader1' => "Strengthen your existing protection at affordable member group rates",
        'preheader2' => "TBD",
    ],
];
